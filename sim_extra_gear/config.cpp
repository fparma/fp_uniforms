...
class CfgVehicles
{
	...
	class rhs_cossack_M43: rhs_cossack_base
	{
		displayName="Soviet M43 Uniform";
		uniformClass = "rhs_uniform_cossack_M43";
		hiddenSelectionsTextures[]=
		{
...
class CfgWeapons
{
	...
	class rhs_uniform_cossack_M43: rhs_uniform_cossack
	{
		displayName="Soviet M43 Uniform";
